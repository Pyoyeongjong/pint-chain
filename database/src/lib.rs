...
impl DatabaseTrait for DBImpl {
    ...
    fn basic(&self, address: &primitives::types::Address) -> Result<Option<primitives::types::Account>, Box<dyn std::error::Error>> {
        match self {
    ...
    fn get_state(&self, block_no: u64) -> Result<(Option<std::collections::HashMap<primitives::types::Address, primitives::types::Account>>, Option<primitives::world::World>), Box<dyn std::error::Error>> {
        match self {
    ...
    fn update(&self, new_account_state: std::collections::HashMap<primitives::types::Address, primitives::types::Account>, new_field_state: primitives::world::World, new_block: primitives::block::Block)
